...
const ProductUpdateForm = (({handleSubmit, handleChange, handleCategoryChange, values, 
    setValues, categories, subOptions, arrayOfSubIds, setArrayOfSubIds, selectedCategory}) => {
    ...
    return(
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
                ...
                <select name="category" value={selectedCategory ? selectedCategory : category._id} className="form-control" onChange={handleCategoryChange}>
